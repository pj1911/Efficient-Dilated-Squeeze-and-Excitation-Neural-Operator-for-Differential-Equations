...
parser.add_argument("--input_x", type=str, default="Pipe_X.npy")
parser.add_argument("--input_y", type=str, default="Pipe_Y.npy")
parser.add_argument("--output_sigma", type=str, default="Pipe_Q.npy")
...
class ResidualSEBlock2d(nn.Module):
    def __init__(self, ch: int, dilation: int):
        ...
        self.conv5 = nn.Conv2d(ch, ch, 3, padding=dilation, dilation=dilation, bias= True)
...
xs = np.linspace(0, 5, s1)
ys = np.linspace(0, 5, s2)
