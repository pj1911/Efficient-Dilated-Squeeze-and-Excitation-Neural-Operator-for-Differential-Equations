...
idx = np.linspace(0, orig_size - 1, target_size)
...
x_full_train = reader.read_field('coeff')[:ntrain]
y_full_train = reader.read_field('sol')[:ntrain]

x_train = x_full_train[:, idx][:, :, idx]
y_train = y_full_train[:, idx][:, :, idx]

reader.load_file(TEST_PATH)
x_full_test = reader.read_field('coeff')[:ntest]
y_full_test = reader.read_field('sol')[:ntest]

x_test = x_full_test[:, idx][:, :, idx]
y_test = y_full_test[:, idx][:, :, idx]
